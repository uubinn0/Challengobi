...
class UserChallengeCategorySerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            'cafe', 'restaurant', 'grocery', 
            'shopping', 'culture', 'hobby', 'drink',
            'transportation', 'etc'
        ]
...
class UserCreateSerializer(serializers.ModelSerializer):
    challenge_categories = UserChallengeCategorySerializer(source='challenge_category', required=True)
    ...
    def create(self, validated_data):
        ...
        UserChallengeCategory.objects.create(
            user=user,
    ...
    def to_representation(self, instance):
        ...
        try:
            ...
            ret['challenge_categories'] = UserChallengeCategorySerializer(challenge_categories).data
...
class UserLoginSerializer(serializers.Serializer):
    ...
    def validate(self, data):
        user = authenticate(email=data['email'], password=data['password']) # email이랑 password만 받음
        if not user:
